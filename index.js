...
document.getElementById("login-btn").addEventListener('click',function(){
  ...
  .then((userCredential) => {
    ...
    if(auth.currentUser.emailVerified===true){   //If email verification is done then user is prometed to home page, else access denied.
      ...
      document.getElementById("status1").innerHTML='Thank you'
      document.getElementById("status2").innerHTML='Successfully Logged in'
      document.getElementById("image").src="tick.png"
      ...
      document.getElementById("status2").innerHTML='Looks like you havent verified your mail address yet. please verify and come back.'
  ...
  .then(() => {
    ...
    request.onload=()=>{
      if(request.status===200){
        ...
        document.getElementById("status1").innerHTML='Thank you'
        document.getElementById("status2").innerHTML='Verification mail has been sent and welcome mail has been sent.  Kindly verify your mail address, so that you can login to our website")  //on successfull registration, login page is visible';
        document.getElementById("image").src="tick.png"
        document.getElementById('ok').style.backgroundColor='green'
        document.getElementById('register-div').style.display="none";
